...
// Encoding middleware does not expose its Effect services at runtime. Treating every
// encoding-side middleware as unsafe makes validation atomic even for untyped callers.
